            ...
            <div class="hk-pg-header mb-10">
                <div>
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                                        data-feather="book"></i></span></span>Voucher</h4>
                </div>
                <div class="d-flex">
                    <div>
                        <a class="hk-pg-title btn btn-primary btn-sm" href="{{URL::to('admin/coupons/create')}}">
                        <span class="mr-5">
                        <span class="feather-icon"><i data-feather="plus-square"></i></span>
                        </span>Add New Coupon</a>
                    </div>
                </div>
            </div>
            <!-- /Title -->
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="table-wrap">
                                    <table id="voucherTbl" class="table table-hover w-100 pb-30">
                                        <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Code</th>
...
// Delete Function
                ...
                function fetchVoucher() {
                    ...
                    console.log(token);
                    $("#voucherTbl").DataTable().destroy();
                    $('#voucherTbl').DataTable({
                        ajax: {
                            url: "{{ url('/api/voucher') }}",
                            type: 'GET',
                            dataType: 'JSON',
                        ...
                        columns: [
                            ...
                            {"data": "code"},
                            {
                                ...
                                "render": function(data, type, full, meta) {
                                     return full["amountType"] == "Percentage" ? full["discountAmount"] + "%" : full["discountAmount"]
                                }
