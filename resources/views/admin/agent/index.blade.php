            ...
            <div class="hk-pg-header mb-10">
                <div>
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i
                                        data-feather="book"></i></span></span>Agents</h4>
                </div>
                <div class="d-flex">
                    <div>
                        <a class="hk-pg-title btn btn-primary btn-sm" href="{{URL::to('admin/agents/create')}}">
                        <span class="mr-5">
                        <span class="feather-icon"><i data-feather="plus-square"></i></span>
                        </span>Add New Agent</a>
                    </div>
                </div>
            </div>
            <!-- /Title -->
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="table-wrap">
                                    <table id="agentsTbl" class="table table-hover w-100 pb-30">
                                        <thead>
                                        <tr>
                                            <!-- <th>ID</th> -->
                                            <th>Agent Email</th>
                        ...
                        columns: [
...

                            {
                                ...
                                "render": function (data, type, full, meta) {
                                    var url = '{{ url("/admin/agents/edit", "id") }}';
