...
<div class="hk-pg-wrapper">
                        ...
                        <div class="col-sm">
                            <div class="row justify-content-md-center">
                                <div class="form-group col-md-4">
                                    ...
                                    <small class="form-text text-danger d-none" id="productNameHelp">Product Name is required</small>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" class="form-control validate-required" id="price"
                                        ...
                                        <small class="form-text text-danger d-none" id="priceHelp">Price is required</small>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control validate-required" id="weight"
                                        ...
                                        <small class="form-text text-danger d-none" id="weightHelp">Weight is required</small>
                            ...
                            <div class="row justify-content-md-center ">
                                <div class="form-group col-md-3">
                                    <label for="category" class="colored label-required">Media Type</label>
                            ...
                            <div class="row justify-content-md-center">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="number" id="stock" class="form-control validate-required"
                                        ...
                                        <small class="form-text text-danger d-none" id="stockHelp">Stock is required</small>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <small class="form-text text-danger d-none" id="locationHelp">Location is required</small>
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <!-- <small class="form-text text-danger d-none" id="prePriceHelp">Previous Price is required</small> -->
                                </div>
                                <div class="form-group col-md-3">
                            ...
                            <div class="row justify-content-md-center">
                                <div class="form-group col-md-6">
                                    ...
                                    <small class="form-text text-danger d-none" id="descriptionHelp">Description is required</small>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <small class="form-text text-danger d-none" id="cartDescriptionHelp">Description is required</small>
                                </div>
                            </div>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#saveProduct', function() {
            console.log("before calling save product");
            saveProduct();
        });
        // Cancel Function
    ...
    function saveProduct() {
        ...
        // // var productImage=(productImage1['name']);
