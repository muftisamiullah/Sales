<nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar">
    ...
    <a class="navbar-brand" href="{{URL::to('agentadmin/dashboard')}}">
        <img class="brand-img d-inline-block" src="{{asset('dist/img/logo-light.png')}}" alt="Agent" />
    </a>
        ...
        <li class="nav-item dropdown dropdown-authentication">
            <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown"
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <span>@if ($name=session()->get('username_agent') ){{$name}}@endif<i class="zmdi zmdi-chevron-down"></i></span>
                    </div>
                </div>
            </a> 
...
<form id="logout-form" action="/agentadmin/logout" method="POST" style="display: none;">
@csrf
<input type="hidden" name="token" value="{{ Session::get('agent_access_token') }}">
</form>
...
//     });
// var pusher = new Pusher('ce02e17dbb0d85fef61c', {
//       cluster: 'ap2',
//       forceTLS: true
//     });
...
//         // console.log(notifications);
//         console.log(messages);
//         var Image='{{asset('dist/img/avatar1.jpg')}}';
//         var Image1='{{asset('dist/img/avatar2.jpg')}}';
//         $('#notification').empty();
