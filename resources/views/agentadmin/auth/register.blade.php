...
<div class="row">
    <div class="col-xl-5 pa-0">
        <div class="auth-cover-img overlay-wrap" style="background-image:url{{asset('dist/img/bg1.jpg')}}">
        ...
        <div class="auth-form-wrap py-xl-0 py-50">
            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-100">
                ...
                @csrf
                    ...
                    <p class="text-center">Already have an account? <a href="{{URL::to('agentadmin')}}">Sign In</a></p>
                </form>
            </div>
        </div>
    </div>
